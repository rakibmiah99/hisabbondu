<html>
    ...
    <html>
        ...
        <h1 class="export-title">Invoice Export</h1>
       ...
       <table id="data_table" class="display table-sm hover table-stipped" style="width:100%">
        ...
        <tbody style="margin-bottom:40px;">
            ...
            <tr>
                ...
                <td>{{$list['invoice_desc']}}</td>
                <td>{{$list['delivery_status']}}</td>
                <td>{{$list['delivery_partner_name']}}</td>
                <td>{{$list['service_charge']}}</td>
                <td>{{$list['delivery_charge']}}</td>
                <td>{{$list['vat']}}</td>
                <td>{{$list['total_product_price']}}</td>
                <td>{{$list['total_discount']}}</td>
                <td>{{$list['total_payable']}}</td>
                <td>{{$list['total_pay']}}</td>
                <td>{{$list['last_payment']}}</td>
                <td>{{$list['total_due']}}</td>
