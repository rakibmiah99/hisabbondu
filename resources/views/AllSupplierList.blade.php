<html>
<head>
    <title>All Supplier Purchase Export</title>
...
<h1 class="export-title">All Supplier Purchase Export</h1>
...
<table id="data_table" class="display table-sm hover table-stipped" style="width:100%">
    ...
    <?php $i=1; ?>
    @foreach($AllSupplierList as $list)
        <tr>
            <td>{{$i++}}</td>
            <td>{{$list->name}}</td>
